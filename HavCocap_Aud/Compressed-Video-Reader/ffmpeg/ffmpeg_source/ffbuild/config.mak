...
FFMPEG_CONFIG_MAK=1
FFMPEG_CONFIGURATION=--prefix=../ffmpeg_install --pkg-config-flags=--static --extra-cflags='-I../ffmpeg_install/include -static' --extra-ldflags='-L../ffmpeg_install/lib -static' --extra-libs='-lpthread -lm' --bindir=../ffmpeg_install/bin --enable-pic --disable-yasm --disable-doc --disable-programs --disable-asm --disable-x86asm
prefix=../ffmpeg_install
LIBDIR=$(DESTDIR)${prefix}/lib
SHLIBDIR=$(DESTDIR)${prefix}/lib
INCDIR=$(DESTDIR)${prefix}/include
BINDIR=$(DESTDIR)../ffmpeg_install/bin
...
WINDRES=windres
DOXYGEN=doxygen
LDFLAGS= -L../ffmpeg_install/lib -static  -Wl,--as-needed -Wl,-z,noexecstack -Wl,--warn-common -Wl,-rpath-link=:libpostproc:libswresample:libswscale:libavfilter:libavdevice:libavformat:libavcodec:libavutil
LDEXEFLAGS=
LDSOFLAGS=
...
avutil_FFLIBS=
EXTRALIBS-avdevice=-lm -latomic -lxcb -lXau -lXdmcp
...
EXTRALIBS-avutil=-pthread -lm -latomic -lX11 -lpthread -lxcb -lXau -lXdmcp
EXTRALIBS-ffplay=
EXTRALIBS-ffprobe=
EXTRALIBS-ffmpeg=
